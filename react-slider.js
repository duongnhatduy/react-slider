(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        export default factory(require('react'), require('prop-types'), require('create-react-class'));
    } else {
    ...
    var ReactSlider = createReactClass({
        ...
        getDefaultProps() {
            return {
                ...
                className: 'slider',
                handleClassName: 'slider-handle round',
        ...
        _getValueFromPosition(position) {
            var diffValue =
                (position / (this.state.sliderLength - this.state.handleSize)) * (this.props.max - this.props.min);
        ...
        _renderHandle(style, child, i) {
            var self = this;
            var className = `${this.props.handleClassName} ${this.props.handleClassName}-${i} ${
        ...
        _fireChangeEvent(event) {
            if (event === 'onChange' && this.props.alertParent) {
                this.props.alertParent(this.state.value);
            }
            if (event === 'onAfterChange' && this.props.alertParentAfterChange) {
                this.props.alertParentAfterChange(this.state.value);
            }
            if (this.props[event]) {
        ...
        render() {
            ...
            if (props.lookuptablevalueZeroIndex) {
                zeroIndexLine = (
                    <div
                        className="zero-index-line"
                        style={{ left: this._calcOffset(props.lookuptablevalueZeroIndex) }}
                    />
                );
            }
